...
function displaySupportedInst() {
    ...
    result += "<div style=\"width:300px; margin: 0 auto; overflow:auto; height:400px;\"><table><tbody>";
    for(i = 0; i < instructions.length; i++) {
	result += "<tr>";
...
function displaySupportedReg() {
    ...
    result += "<div style=\"width:330px; margin: 0 auto; overflow:auto; height:400px;\"><table><tbody>";
